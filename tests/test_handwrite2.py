...
class TestHandwrite2(unittest.TestCase):
    ...
    def get_default_template2():
        ...
        template2 = dict(
            page_settings=[
                dict(
                    background=PIL.Image.open("./data/backgrounds/会议记录/even.png"),
                ...
                dict(
                    background=PIL.Image.open("./data/backgrounds/会议记录/odd.png"),
    ...
    def test_even_odd(self):
        ...
        for i, im in enumerate(ims):
            ...
            self.assertTrue(self.compare(im, PIL.Image.open("./data/images/test_even_odd{}.png".format(i))))
